...
class ActivitiesControllerTest extends Specification {
    ...
    def 'should return sorted activities with latest Strava activities when GET /activities'() {
        ...
        def stravaActivity2 = stravaActivity(1234, of(2022, JANUARY, 12, 12, 20), StravaActivityType.Ride)
        def activity3 = activity(12345, of(2022, JANUARY, 20, 12, 20), StravaActivityType.Swim)
        def stravaActivity3 = stravaActivity(12345, of(2022, JANUARY, 20, 12, 20), StravaActivityType.Swim)
        def activity4 = activity(123456, of(2022, JANUARY, 21, 12, 20), StravaActivityType.Workout)
        def stravaActivity4 = stravaActivity(123456, of(2022, JANUARY, 21, 12, 20), StravaActivityType.Workout)
