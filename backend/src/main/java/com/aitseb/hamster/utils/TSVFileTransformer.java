...
public class TSVFileTransformer {
    ...
    public static void main(String[] args) {
        ...
        String inputFilePath = hamsterDir + "/backend/src/main/resources/" + "Rozpiska2019.tsv";
        String outputFilePath = hamsterDir + "/backend/src/main/resources/" + "Rozpiska2019.csv";
    ...
    public static void convertTabsToPipes(String inputFilePath, String outputFilePath) throws IOException {
        try (BufferedReader reader = new BufferedReader(new FileReader(inputFilePath));
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (!columns.get(2).startsWith("2019")) {
                    throw new IllegalArgumentException("Wrong year in activity. Should be 2019 and not: " + columns.get(2));
                }
